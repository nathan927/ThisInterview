...
export const translations = {
  en: {
    ...
    clearAllConfirmTitle: 'Clear All Questions',
    ...
    delete: 'Delete',
    confirm: 'Confirm',
    confirmDeleteRecording: 'Are you sure you want to delete this audio recording?',
  },
  zh: {
    ...
    delete: '刪除',
    confirm: '確定',
    confirmDeleteRecording: '確定要刪除這個錄音嗎？',
  }
};
